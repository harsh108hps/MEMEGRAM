      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/create" className="hover:text-pink-500">Create Meme</Link></li>
            <li><Link to="/leaderboard" className="hover:text-pink-500">Leaderboard</Link></li>
            <li><Link to="/dashboard" className="hover:text-pink-500">Dashboard</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="hover:text-pink-500"><Youtube size={20} /></a>
          </div>
        </div>
      </div>
